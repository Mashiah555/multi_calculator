...
class _LengthConverterState extends ConsumerState<LengthConverter> {
  ...
  Widget build(BuildContext context) {
    ...
    // The different length units as MenuSheet items.
    final lengthUnits = [
      MenuItem(id: 'km', title: l10n.kilometer, subtitle: l10n.kilometerCode),
      MenuItem(id: 'm', title: l10n.meter, subtitle: l10n.meterCode),
      MenuItem(id: 'cm', title: l10n.centimeter, subtitle: l10n.centimeterCode),
      MenuItem(id: 'mm', title: l10n.millimeter, subtitle: l10n.millimeterCode),
      MenuItem(id: 'mile', title: l10n.mile, subtitle: l10n.mileCode),
      MenuItem(id: 'yard', title: l10n.yard, subtitle: l10n.yardCode),
      MenuItem(id: 'foot', title: l10n.foot, subtitle: l10n.footCode),
      MenuItem(id: 'inch', title: l10n.inch, subtitle: l10n.inchCode),
      MenuItem(id: 'ly', title: l10n.lightYear, subtitle: l10n.lightYearCode),
    ];
    MenuItem firstUnit = lengthUnits[0];
    MenuItem secondUnit = lengthUnits[0];
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (selection != null) {
                        final selectedItem = lengthUnits.firstWhere(
                          (s) => s.id == selection,
                        );
                        setState(() {
                          firstUnit = selectedItem;
                        });
                      }
                    },
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          if (firstUnit.subtitle != null &&
                              firstUnit.subtitle!.isNotEmpty)
